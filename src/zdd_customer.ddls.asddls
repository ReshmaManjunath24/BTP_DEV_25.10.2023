...
--composition [0..*] of ZDD_CUST_COMMENT    as _zdd_comments
  ...
  association [1..*] to ZCDS_CREDIT_MGT     as _credit    on $projection.zcustomer_num = _credit.zcustomer_num
   association [1..*] to ZDD_CLAP_USER_INFO     as _userinfo    on $projection.zcreated_by = _userinfo.UserID
{
  key  zcustomer_num,
...
cast(_userinfo.PersonFullName as abap.char(70) ) as Initiator_name,
//cast('t_apattar@Iffco.com' as abap.char(70) ) as Initiator_email,
cast(_userinfo.DefaultEmailAddress as abap.char(70) ) as Initiator_email,
